          ...
          <div className="md:col-span-2 bg-[#1E293B] p-8 text-white hidden md:flex flex-col justify-center space-y-6">
            ...
            <div>
              ...
              <p className="text-slate-400 mt-2">
                Manage your clinical practice digitally with MediConnect's
                advanced tools.
              </p>
            </div>
            <ul className="space-y-4 text-sm text-slate-300">
              <li className="flex items-center gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Manage
                appointments
              </li>
              <li className="flex items-center gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Digital
                prescriptions (PDF)
              </li>
              <li className="flex items-center gap-3">
                <div className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Reach
                more patients
              </li>
            </ul>
          </div>
            ...
            <Tabs defaultValue="login" className="w-full">
              ...
              <TabsContent value="login">
                <div className="mb-6">
                  ...
                  <p className="text-gray-500 text-sm">
                    Welcome back, doctor. Please sign in.
                  </p>
                </div>
                <Form {...loginForm}>
                  <form
                  ...
                  >
                        ...
                        <FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input
                                {...field}
                                className="pl-10 h-12 bg-gray-50 border-gray-100 focus:bg-white transition-all"
                          ...
                          <FormControl>
                            <div className="relative">
                              <Input
                                ...
                                className="pr-10 h-12 bg-gray-50 border-gray-100 focus:bg-white transition-all"
                              />
                              <button
                                type="button"
                    ...
                    <Button
                      type="submit"
                      className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold shadow-lg shadow-blue-100"
              ...
              <TabsContent value="signup">
                <div className="mb-6">
                  ...
                  <p className="text-gray-500 text-sm">
                    Become part of our specialist network.
                  </p>
                </div>
                <Form {...signupForm}>
                  <form
                  ...
                  >
                          ...
                          <FormItem className="md:col-span-2">
                            ...
                            <FormControl>
                              <Input
                                ...
                                {...field}
                                className="bg-gray-50 border-gray-100 cursor-pointer"
                              />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                          ...
                          <FormItem>
                            ...
                            <FormControl>
                              <div className="relative">
                                ...
                                <Input
                                  {...field}
                                  className="pl-10 h-11 bg-gray-50 border-gray-100"
                                />
                              </div>
                            </FormControl>
                            <FormMessage />
                            ...
                            <FormControl>
                              <div className="relative">
                                <Input
                                  {...field}
                                  type={showPassword ? "text" : "password"}
                                  className="pr-10 h-11 bg-gray-50 border-gray-100"
                                />
                                <button
                                  type="button"
                                  onClick={() => setShowPassword(!showPassword)}
                    ...
                    <Button
                      type="submit"
                      className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-bold mt-4 shadow-lg shadow-blue-100"
